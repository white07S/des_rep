...
from backend.module.codex_agents.framework.agent_types import AgentsConfig, MCPServerConfig, ResolvedAgentConfig
from backend.module.config_handler import settings
from backend.module.logging import LoggingInterceptor

FRAMEWORK_DIR = Path(__file__).resolve().parent
CODEX_AGENTS_DIR = FRAMEWORK_DIR.parent
REPO_ROOT = FRAMEWORK_DIR.parents[3]
INSTANCES_DIR = CODEX_AGENTS_DIR / "instances"
SNAPSHOT_ROOT = REPO_ROOT / "agents_snapshots"
DEFAULT_CONFIG_PATH = INSTANCES_DIR / "agents_config.toml"
...
def assemble_agents(config_path: Path | None = None) -> List[ResolvedAgentConfig]:
    ...
    instructions_root = (INSTANCES_DIR / config.defaults.instructions_dir).resolve()
